...
public class InstrumentedStatement implements Statement {
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        try (Span span = Span.startSpan("Execute Query: " + sql)) {
    ...
    public int executeUpdate(String sql) throws SQLException {
        try (Span span = Span.startSpan("Execute Update: " + sql)) {
            span.addAnnotation(AnnotationNames.SERVICE_NAME, connection.getUrl());
            span.addAnnotation(AnnotationNames.CLIENT_SENT);
    ...
    public boolean execute(String sql) throws SQLException {
        try (Span span = Span.startSpan("Execute: " + sql)) {
            span.addAnnotation(AnnotationNames.SERVICE_NAME, connection.getUrl());
            span.addAnnotation(AnnotationNames.CLIENT_SENT);
    ...
    public int[] executeBatch() throws SQLException {
        try (Span span = Span.startSpan("Execute Batch")) {
            span.addAnnotation(AnnotationNames.SERVICE_NAME, connection.getUrl());
            span.addAnnotation(AnnotationNames.CLIENT_SENT);
